...
if __name__ == "__main__":
    ...
    testString = "CCCCCGG7FGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGFGGGGGGFFGGGGGG9EGGF8F8FGGFGGGFGGFGGGGFG8FFGEGGGGGGGEFGGGGGGCFGGFFGEGEDFGGGGCFGFGG9,CACGGGGEGGEGGFGFGFGGEEGGGF8EGDDGGGGFGGGFFGGEGGGD*:>ECCB:AFG>)::+@>CFFG?FFD><>FE8DFF>>F31CEC*1<)9FF=**.68*:<FC:1=+9CFG**,7C?*0*0/>F<?).7)4:(4CF3"
    ee = cumulativeExpectedErrorArray(testString, encodingSchemes.illumina)
    print("something")